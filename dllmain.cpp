...
t_RtlRaiseException* RtlRaiseException;
...
extern char gdt[], armsyscallhandler[56], x86syscallhandler[], x86faulthandler[];
...
)
{
	...
	case DLL_PROCESS_ATTACH:
		*(UINT64*)(&armsyscallhandler[48]) = (UINT64)&i386linuxsyscalltable;
		...
		*(UINT32*)(&x86faulthandler[5]) = (UINT32)&genfaulty;
		...
		(*(UINT64*)(&gdt[0x00])) = 0;
#ifdef _AMD64_
		(*(UINT64*)(&gdt[0x20])) = 0x00cf9e000000ffff;
		(*(UINT64*)(&gdt[0x28])) = 0x00cf96000000ffff;
#else
#ifdef _ARM64_
		(*(UINT64*)(&gdt[0x18])) = 0x00cf9e000000ffff;
		(*(UINT64*)(&gdt[0x20])) = 0x00cf96000000ffff;
#endif
#endif
		...
		RtlRaiseException = (t_RtlRaiseException*)GetProcAddress(hofntdll, "RtlRaiseException");
...
#ifdef _ARM64_
			(*(UINT64*)(&gdt[0x38])) = 0x00cf96000000ffff | ((((UINT64)(PtrToUlong(wowteb) & 0xffffff)) << 16) | (((UINT64)(PtrToUlong(wowteb) & 0xff000000)) << 32));
#endif
	...
	static UINT32 i386memaccess(memaccessandpt* _this, int prm_0, int prm_1, int prm_2) {
		...
		case 0x23:
			...
			if (prm_0 == 0) {
				...
				Param = (DWORD*)_this->i386core->s.cpu_regs.reg[CPU_EAX_INDEX].d;
				Func = *(DWORD*)(_this->i386core->s.cpu_regs.eip.d - 2 - 4);
				ret = ((func*)(((UINT64)(0x100000000-1)) & ((UINT64)Func)))(Param);
			}
...
void genfaulty(UINT64 prm_0) { 
	EXCEPTION_RECORD rec;
	rec.ExceptionCode = STATUS_ACCESS_VIOLATION;
	rec.ExceptionFlags = EH_NONCONTINUABLE;
	rec.ExceptionRecord = NULL;
	rec.ExceptionAddress = (void*)prm_0;
	rec.NumberParameters = 0;
	RtlRaiseException(&rec);
}

UINT32 i386linuxsyscalltable[] = {
0,
__NR_exit,
__NR_fork,
__NR_read,
...
#define charfromptr32(a) ((UINT8)((((UINT64)a)>>0)&0xff)),((UINT8)((((UINT64)a)>>8)&0xff)),((UINT8)((((UINT64)a)>>16)&0xff)),((UINT8)((((UINT64)a)>>24)&0xff))
#define charfromptr64(a) ((UINT8)((((UINT64)a)>>0)&0xff)),((UINT8)((((UINT64)a)>>8)&0xff)),((UINT8)((((UINT64)a)>>16)&0xff)),((UINT8)((((UINT64)a)>>24)&0xff)),((UINT8)((((UINT64)a)>>32)&0xff)),((UINT8)((((UINT64)a)>>40)&0xff)),((UINT8)((((UINT64)a)>>48)&0xff)),((UINT8)((((UINT64)a)>>56)&0xff))
...
syscalltable:
*/
char armsyscallhandler[] = {0xe6,0x03,0x00,0x2a,0xc0,0x04,0x40,0xb9,0xc1,0x08,0x40,0xb9,0xc2,0x0c,0x40,0xb9,0xc3,0x10,0x40,0xb9,0xc4,0x14,0x40,0xb9,0xc5,0x18,0x40,0xb9,0xc9,0x00,0x40,0xb9,0x88,0x00,0x00,0x58,0x08,0x59,0x69,0xb8,0x01,0x00,0x00,0xd4,0xc0,0x03,0x5f,0xd6,charfromptr64(&i386linuxsyscalltable) };

char x86faulthandler[] = { 0x58,0x58,0x50,0xeb,0x04,charfromptr32(&genfaulty),0xe5,0xe6,0xcf };
char x86syscallhandler[] = { 0x55,0x57,0x56,0x52,0x51,0x53,0x50,0x89,0xe0,charfromptr32(&armsyscallhandler),0x83,0xc4,0x38,0xcf };

bool x86faultwitherrorcode[] = { false, false, false, false, false, false, false, false, true, false, true, true, true, true, true, false, false, true, false, false, false, true, false, false, false, false, false, false, false, true, true, false };
...
#ifdef _ARM64_
			(*(UINT64*)((*(UINT64*)(&idt)) + (8 * cnt))) = 0x0000820000180000 | (((((UINT64)& x86faulthandler) + (x86faultwitherrorcode[cnt] ? 0 : 1)) >> 0) & 0xFFFF) | ((((((UINT64)& x86faulthandler) + (x86faultwitherrorcode[cnt] ? 0 : 1)) >> 16) & 0xFFFF) << 48);
#else
			(*(UINT64*)((*(UINT64*)(&idt)) + (8 * cnt))) = 0x0000820000200000 | (((((UINT64)& x86faulthandler) + (x86faultwitherrorcode[cnt] ? 0 : 1)) >> 0) & 0xFFFF) | ((((((UINT64)& x86faulthandler) + (x86faultwitherrorcode[cnt] ? 0 : 1)) >> 16) & 0xFFFF) << 48);
#endif
		}

#ifdef _ARM64_
		(*(UINT64*)((*(UINT64*)(&idt)) + (8 * 0x80))) = 0x0000820000180000 | ((((UINT64)& x86syscallhandler) >> 0) & 0xFFFF) | (((((UINT64)& x86syscallhandler) >> 16) & 0xFFFF) << 48);
#else
		(*(UINT64*)((*(UINT64*)(&idt)) + (8 * 0x80))) = 0x0000820000200000 | ((((UINT64)& x86syscallhandler) >> 0) & 0xFFFF) | (((((UINT64)& x86syscallhandler) >> 16) & 0xFFFF) << 48);
#endif
